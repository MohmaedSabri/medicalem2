...
const enTranslations = {
	translation: {
		...
		paymentCashOnDeliveryDesc: "Pay with cash upon delivery.",
		vat: "VAT",
		...
		showingXOfYReviews: "Showing {{shown}} of {{total}} reviews",
...
const arTranslations = {
	translation: {
		...
		enterCountry: "من فضلك ادخل اسم  الدوله",
		viewProducts: "عرض المنتجات",
		subcategories: "الفئات الفرعية",
		viewAllProducts: "عرض الجميع ",
		...
		financingAvailable: "يتوفر تمويل",
		bulkPricingAvailable: "أسعار خاصة للطلبات الكبيرة",
		additionalInformation: "معلومات إضافية",
		customerReviews: "آراء العملاء",
		noReviewsYet: "لا توجد تقييمات بعد. كن أول من يترك تقييماً!",
		showingXOfYReviews: "إظهار {{shown}} من {{total}} تقييمات",
