...
const EditDoctorForm: React.FC<EditDoctorFormProps> = ({ doctor, onClose }) => {
  ...
  const [formData, setFormData] = useState<UpdateDoctorData>({
    ...
    title: { en: doctor.title.en, ar: doctor.title.ar },
    description: { en: doctor.description.en, ar: doctor.description.ar },
    image: doctor.image,
    skills: [...doctor.skills],
    qualifications: [...doctor.qualifications],
    experience: [...doctor.experience],
    location: { en: doctor.location.en, ar: doctor.location.ar },
    contact: doctor.contact,
    socialMedia: [...doctor.socialMedia],
    specialization: { en: doctor.specialization.en, ar: doctor.specialization.ar },
  });
  ...
  const handleInputChange = (field: keyof UpdateDoctorData, value: any) => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const handleBilingualInputChange = (field: keyof UpdateDoctorData, lang: 'en' | 'ar', value: string) => {
    setFormData(prev => ({
      ...prev,
      [field]: {
        ...(prev[field] as any),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateDoctorMutation.mutateAsync({ id: doctor._id, data: formData });
