...
const AddPostForm: React.FC<AddPostFormProps> = ({ onClose }) => {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		if (
			useRichEditor &&
			(contentBlocksEn.length > 0 || contentBlocksAr.length > 0)
		) {
									...
									<div className='border border-gray-300 rounded-lg p-4 space-y-4'>
												...
												<div className='flex items-center justify-between mb-2'>
													...
													<div className='flex items-center space-x-2'>
														<button
															...
															onClick={() =>
																setContentBlocksEn(
																	removeContentBlock(contentBlocksEn, index)
																)
															}
												...
												{block.type === "paragraph" ? (
													<div className='space-y-2'>
														<input
															...
															onChange={(e) =>
																setContentBlocksEn(
																	updateContentBlock(contentBlocksEn, index, {
										...
										<div className='flex space-x-2'>
											<button
												...
												onClick={() =>
													setContentBlocksEn(
														addContentBlock(contentBlocksEn, "paragraph", {})
													)
												}
											...
											<button
												...
												onClick={() =>
													setContentBlocksEn(
														addContentBlock(contentBlocksEn, "image", {})
													)
												}
									...
									<div className='border border-gray-300 rounded-lg p-4 space-y-4'>
												...
												<div className='flex items-center justify-between mb-2'>
													...
													<div className='flex items-center space-x-2'>
														<button
															...
															onClick={() =>
																setContentBlocksAr(
																	removeContentBlock(contentBlocksAr, index)
																)
															}
															className='text-red-600 hover:text-red-800'>
															<X className='w-4 h-4' />
												...
												{block.type === "paragraph" ? (
													<div className='space-y-2'>
														<input
															...
															onChange={(e) =>
																setContentBlocksAr(
																	updateContentBlock(contentBlocksAr, index, {
																		title: e.target.value,
																	})
																)
															}
										...
										<div className='flex space-x-2'>
											<button
												...
												onClick={() =>
													setContentBlocksAr(
														addContentBlock(contentBlocksAr, "paragraph", {})
													)
												}
												className='px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm'>
												+ إضافة فقرة
											...
											<button
												...
												onClick={() =>
													setContentBlocksAr(
														addContentBlock(contentBlocksAr, "image", {})
													)
												}
												className='px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm'>
												+ إضافة صورة
					...
					<div className='flex justify-end space-x-4 pt-6 border-t border-gray-200'>
						...
						<button
							...
							disabled={
								...
								(useRichEditor
									? contentBlocksEn.length === 0 || contentBlocksAr.length === 0
									: contentEn.length < 10 || contentAr.length < 10)
							}
