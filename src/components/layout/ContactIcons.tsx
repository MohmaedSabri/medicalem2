	...
	return (
		<div
			...
			<motion.div
				...
				<Link
					to='/cart'
					className={`${iconBaseClasses} hover:text-primary-600 mx-2 overflow-visible`}>
			...
			<motion.button
				...
				className='group relative items-center px-2 py-2 sm:px-3 sm:py-3 rounded-full bg-gradient-to-r from-primary-600 to-primary-700 text-white 
        hover:from-primary-700 hover:to-primary-800 transition-all duration-500 ease-out
         shadow-lg hover:shadow-2xl hover:shadow-primary-500/50 overflow-hidden hidden xl:flex'
				...
				<div
					...
					<Phone
						className={`h-3 w-3 sm:h-4 sm:w-4 mx-1 sm:mx-2 group-hover:scale-110 transition-all duration-300`}
					/>
