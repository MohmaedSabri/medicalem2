...
const AddDoctorForm: React.FC<AddDoctorFormProps> = ({ onClose }) => {
  ...
  const handleSubmit = async (data: DoctorCreateSchema) => {
    ...
    try {
      await createDoctorMutation.mutateAsync(payload as unknown as import('../../types').CreateDoctorData);
        ...
        >
          ...
          <div className="p-6 space-y-8">
            ...
            <GenericForm<DoctorCreateSchema>
              ...
              submitButtonText={createDoctorMutation.isPending ? t('saving') : t('addDoctor')}
              className='w-full'
            />
