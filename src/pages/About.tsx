			...
			<section className='py-16 '>
				<div className='container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8'>
					<div className='p-6 rounded-2xl border border-primary-100 bg-primary-50'>
						<h3 className='text-[#0f172a] font-semibold text-xl mb-2'>
							{t("ourMission")}
						</h3>
						<p className='text-slate-600'>{t("missionDescription")}</p>
					</div>
					<div className='p-6 rounded-2xl border border-primary-100 bg-primary-50'>
						<h3 className='text-[#0f172a] font-semibold text-xl mb-2'>
							{t("ourVision")}
						</h3>
						<p className='text-slate-600'>{t("visionDescription")}</p>
					</div>
					<div className='p-6 rounded-2xl border border-primary-100 bg-primary-50'>
						<h3 className='text-[#0f172a] font-semibold text-xl mb-2'>
							{t("ourValues")}
						</h3>
						<p className='text-slate-600'>{t("valuesDescription")}</p>
					</div>
				</div>
			</section>
